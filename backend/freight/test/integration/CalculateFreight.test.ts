...
test.skip('Deve simular o frete para um pedido sem CEP de origem e destino', async function () {
...
test.skip('Deve simular o frete para um pedido com CEP de origem e destino usando fake', async function () {
    // const connection = new PgPromiseConnection();
    // const productData = new ProductDataDatabase(connection);
    // const zipcodeData: ZipcodeData = {
    //     async get(code: string): Promise<Zipcode | undefined> {
...
test.skip('Deve simular o frete para um pedido com CEP de origem e destino usando banco de dados', async function () {
    // const connection = new PgPromiseConnection();
    // const productData = new ProductDataDatabase(connection);
